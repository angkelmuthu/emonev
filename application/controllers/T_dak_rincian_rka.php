...
class T_dak_rincian_rka extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['total_rows'] = $this->T_dak_rincian_model->total_rows($q);
        $t_dak_rincian_rka = $this->T_dak_rincian_model->get_limit_data($config['per_page'], $start, $q);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2020-10-30 13:53:40 */
/* http://harviacode.com */