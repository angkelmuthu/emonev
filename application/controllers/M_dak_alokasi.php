...
class M_dak_alokasi extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('M_dak_alokasi_model');
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            ...
            $config['first_url'] = base_url() . 'index.php/m_dak_alokasi/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'index.php/m_dak_alokasi/index/';
            $config['first_url'] = base_url() . 'index.php/m_dak_alokasi/index/';
        }

        $config['per_page'] = 10;
        $config['page_query_string'] = FALSE;
        $config['total_rows'] = $this->M_dak_alokasi_model->total_rows($q);
        $m_dak_alokasi = $this->M_dak_alokasi_model->get_limit_data($config['per_page'], $start, $q);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2020-09-21 15:33:00 */
/* http://harviacode.com */