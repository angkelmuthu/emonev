...
class M_satker_jenis extends CI_Controller
{
    ...
    public function excel()
    {
        ...
        $namaFile = "m_satker_jenis.xls";
        $judul = "m_satker_jenis";
        $tablehead = 0;
        $tablebody = 1;
        $nourut = 1;
        //penulisan header
        ...
        foreach ($this->M_satker_jenis_model->get_all() as $data) {
            $kolombody = 0;
...
/* Generated by Harviacode Codeigniter CRUD Generator 2020-07-12 16:40:41 */
/* http://harviacode.com */