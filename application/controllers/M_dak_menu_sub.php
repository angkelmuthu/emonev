...
class M_dak_menu_sub extends CI_Controller
{
    ...
    public function excel()
    {
        ...
        $namaFile = "m_dak_menu_sub.xls";
        $judul = "m_dak_menu_sub";
        $tablehead = 0;
        $tablebody = 1;
        $nourut = 1;
        //penulisan header
	...
	xlsWriteLabel($tablehead, $kolomhead++, "Dak");
	xlsWriteLabel($tablehead, $kolomhead++, "Id Dak Menu Group");
	...
	foreach ($this->M_dak_menu_sub_model->get_all() as $data) {
            $kolombody = 0;

            //ubah xlsWriteLabel menjadi xlsWriteNumber untuk kolom numeric
            xlsWriteNumber($tablebody, $kolombody++, $nourut);
	    xlsWriteLabel($tablebody, $kolombody++, $data->dak);
	    xlsWriteNumber($tablebody, $kolombody++, $data->id_dak_menu_group);
