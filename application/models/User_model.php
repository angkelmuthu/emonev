...
class User_model extends CI_Model
{
    ...
    function json()
    {
        $this->datatables->select('id_users,full_name,email,m_satker.nmsatker,nama_level,is_aktif');
        ...
        $this->datatables->join('m_satker', 'tbl_user.kdsatker = m_satker.kdsatker');
