    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>INPUT DATA MASTER MENU SUB</h2>
                    ...
                    <div class="panel-content">
                        <form action="<?php echo $action; ?>" method="post">
                            ...
                            <table class='table table-striped'>
                                ...
                                <tr>
                                    <td width='200'>Dak <?php echo form_error('dak') ?></td>
                                    <td>
                                        <div class="frame-wrap">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="dak" class="custom-control-input" id="dak" value="DAK RUJUKAN">
                                                <label class="custom-control-label" for="dak">DAK RUJUKAN</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="dak" class="custom-control-input" id="dak" value="DAK DASAR">
                                                <label class="custom-control-label" for="dak">DAK DASAR</label>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td width='200'>Menu Group <?php echo form_error('id_dak_menu_group') ?></td>
                                    <td><?php echo radiobtn_dinamis('id_dak_menu_group', 'm_dak_menu_group', 'nama', 'id_dak_menu_group') ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="id_dak_menu_sub" value="<?php echo $id_dak_menu_sub; ?>" />
                                        <button type="submit" class="btn btn-warning waves-effect waves-themed"><i class="fal fa-save"></i> <?php echo $button ?></button>
                                        <a href="<?php echo site_url('m_dak_menu_sub') ?>" class="btn btn-info waves-effect waves-themed"><i class="fal fa-sign-out"></i> Kembali</a></td>
                                </tr>
                            </table>
                        </form>
                    </div>
