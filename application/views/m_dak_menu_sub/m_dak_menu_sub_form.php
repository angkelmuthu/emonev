    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>INPUT DATA M_DAK_MENU_SUB</h2>
                        ...
                        <form action="<?php echo $action; ?>" method="post">
                            ...
                            <table class='table table-striped'>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" name="dak" id="dak" placeholder="Dak" value="<?php echo $dak; ?>" /></td>
                                </tr>
                                <tr>
                                    <td width='200'>Id Dak Menu Group <?php echo form_error('id_dak_menu_group') ?></td>
                                    <td><?php echo select2_dinamis('id_dak_menu_group', 'm_dak_menu_group', 'nama_dak_menu_group', 'id_dak_menu_group') ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td><input type="hidden" name="id_dak_menu_sub" value="<?php echo $id_dak_menu_sub; ?>" />
