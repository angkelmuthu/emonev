...
<table class='table table-striped'>
	    ...
	    <tr><td width='200'>Kdsatuan <?php echo form_error('kdsatuan') ?></td><td><input type="text" class="form-control" name="kdsatuan" id="kdsatuan" placeholder="Kdsatuan" value="<?php echo $kdsatuan; ?>" /></td></tr>
	    ...
	    <a href="<?php echo site_url('m_satuan') ?>" class="btn btn-info waves-effect waves-themed"><i class="fal fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
