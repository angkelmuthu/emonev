...
<table class='table table-striped'>
	    ...
	    <tr><td width='200'>Nama Jenis Output <?php echo form_error('nama_jenis_output') ?></td><td><input type="text" class="form-control" name="nama_jenis_output" id="nama_jenis_output" placeholder="Nama Jenis Output" value="<?php echo $nama_jenis_output; ?>" /></td></tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_jenis_output" value="<?php echo $id_jenis_output; ?>" /> 
	    <button type="submit" class="btn btn-warning waves-effect waves-themed"><i class="fal fa-save"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('m_jenis_output') ?>" class="btn btn-info waves-effect waves-themed"><i class="fal fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
