...
<div class="row">
    <div class="col-xl-12">
	    ...
	    <tr><td>Id Dak Jenis</td><td><?php echo $id_dak_jenis; ?></td></tr>
	    <tr><td>Id Dak Kelompok</td><td><?php echo $id_dak_kelompok; ?></td></tr>
	    <tr><td>Id Dak Sub Bidang</td><td><?php echo $id_dak_sub_bidang; ?></td></tr>
	    <tr><td>Id Satker</td><td><?php echo $id_satker; ?></td></tr>
	    <tr><td>Tahun</td><td><?php echo $tahun; ?></td></tr>
	    <tr><td>Nilai Alokasi</td><td><?php echo $nilai_alokasi; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('m_dak_alokasi') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td></tr>
	</table>
</div>
</div>
