            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="row">
                            <div class="col-md-6">
                                <?php //echo anchor(site_url('t_dak_rincian_rka/create'), '<i class="fal fa-plus-square" aria-hidden="true"></i> Tambah Data', 'class="btn btn-primary btn-sm waves-effect waves-themed"');
                                ?>
                                <?php echo anchor(site_url('t_dak_rincian_rka/import'), ' Import Data Excel', 'class="btn btn-success btn-sm waves-effect waves-themed"'); ?>
                            </div>
                            <div class="col-md-6">
