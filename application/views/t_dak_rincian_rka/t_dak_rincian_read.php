...
<div class="row">
    <div class="col-xl-12">
	    ...
	    <tr><td>Kode Satker Lokasi</td><td><?php echo $kode_satker_lokasi; ?></td></tr>
	    <tr><td>Kode Nonsatker Lokasi</td><td><?php echo $kode_nonsatker_lokasi; ?></td></tr>
	    <tr><td>Jenis Fasyankes</td><td><?php echo $jenis_fasyankes; ?></td></tr>
	    <tr><td>Instalasi</td><td><?php echo $instalasi; ?></td></tr>
	    <tr><td>Ruangan</td><td><?php echo $ruangan; ?></td></tr>
	    <tr><td>Sarana</td><td><?php echo $sarana; ?></td></tr>
	    <tr><td>Nip Pengisi</td><td><?php echo $nip_pengisi; ?></td></tr>
	    <tr><td>Nama Pengisi</td><td><?php echo $nama_pengisi; ?></td></tr>
	    <tr><td>Jabatan Pengisi</td><td><?php echo $jabatan_pengisi; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('t_dak_rincian_rka') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td></tr>
	</table>
</div>
</div>
