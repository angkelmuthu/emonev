        ...
        <div class="subheader-block d-lg-flex align-items-center">
            <form method="GET" action="">
                <div class="form-group">
                    <select name="th" onchange="this.form.submit();" class="select2 form-control w-100" id="th">
                        <option value="">Pilih Tahun</option>
                        <?php foreach ($dt_tahun as $dt) {
                        ...
                        <div class="panel-container show">
                            <div class="panel-content">
                                <div class="progress progress-lg">
                                    ...
                                    ?>
                                    <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $rka; ?>%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><?php echo $rka; ?>%</div>
                                </div>
                            </div>
                        </div>
                    </div>
