                    ...
                    <div class="panel-content">
                        <form action="<?php echo $action; ?>" method="post">
                            ...
                            <table class='table table-striped'>
                                ...
                                <tr>
                                    <td width='200'>Kode Dak Komponen <?php echo form_error('kode_dak_komponen') ?></td>
                                    <td><input type="text" class="form-control" name="kode_dak_komponen" id="kode_dak_komponen" placeholder="Kode Dak Komponen" value="<?php echo $kode_dak_komponen; ?>" /></td>
                                </tr>
                                <tr>
                                    <td width='200'>Nama Dak Komponen <?php echo form_error('nama_dak_komponen') ?></td>
                                    <td><input type="text" class="form-control" name="nama_dak_komponen" id="nama_dak_komponen" placeholder="Nama Dak Komponen" value="<?php echo $nama_dak_komponen; ?>" /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td><input type="hidden" name="id_dak_komponen" value="<?php echo $id_dak_komponen; ?>" />
                                        <button type="submit" class="btn btn-warning waves-effect waves-themed"><i class="fal fa-save"></i> <?php echo $button ?></button>
                                        <a href="<?php echo site_url('m_dak_komponen') ?>" class="btn btn-info waves-effect waves-themed"><i class="fal fa-sign-out"></i> Kembali</a></td>
                                </tr>
                            </table>
                        </form>
                    </div>
