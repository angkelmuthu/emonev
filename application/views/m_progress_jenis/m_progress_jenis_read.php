...
<div class="row">
    <div class="col-xl-12">
	    ...
	    <tr><td>Nama Progres</td><td><?php echo $nama_progres; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('m_progress_jenis') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td></tr>
	</table>
</div>
</div>
