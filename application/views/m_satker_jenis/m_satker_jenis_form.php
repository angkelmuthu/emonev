...
<table class='table table-striped'>
	    ...
	    <tr><td width='200'>Nama Satker Jenis <?php echo form_error('nama_satker_jenis') ?></td><td><input type="text" class="form-control" name="nama_satker_jenis" id="nama_satker_jenis" placeholder="Nama Satker Jenis" value="<?php echo $nama_satker_jenis; ?>" /></td></tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_satker_jenis" value="<?php echo $id_satker_jenis; ?>" /> 
	    <button type="submit" class="btn btn-warning waves-effect waves-themed"><i class="fal fa-save"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('m_satker_jenis') ?>" class="btn btn-info waves-effect waves-themed"><i class="fal fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
