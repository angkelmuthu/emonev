...
foreach ($iterator as list($non_pk, $kolom, $tmp, $array1, $array2, $array3)) {
    ...
    } elseif ($tmp['test'] == 'nomr') {
        $nomr = "this->uri->segment(3)";
        $string .= "\n\t    <tr><td width='200'>" . label($non_pk["column_name"]) . " <?php echo form_error('" . $non_pk["column_name"] . "') ?></td><td><input type=\"text\" class=\"form-control\" name=\"" . $non_pk["column_name"] . "\" id=\"" . $non_pk["column_name"] . "\" placeholder=\"" . label($non_pk["column_name"]) . "\" value=\"<?php echo $" . $nomr . " ?>\" readonly/></td></tr>";
    } elseif ($tmp['test'] == 'idxdaftar') {
        $idxdaftar = "this->uri->segment(4)";
        $string .= "\n\t    <tr><td width='200'>" . label($non_pk["column_name"]) . " <?php echo form_error('" . $non_pk["column_name"] . "') ?></td><td><input type=\"text\" class=\"form-control\" name=\"" . $non_pk["column_name"] . "\" id=\"" . $non_pk["column_name"] . "\" placeholder=\"" . label($non_pk["column_name"]) . "\" value=\"<?php echo $" . $idxdaftar . " ?>\" readonly/></td></tr>";
    } else {
        $string .= "\n\t    <tr><td width='200'>" . label($non_pk["column_name"]) . " <?php echo form_error('" . $non_pk["column_name"] . "') ?></td><td><input type=\"text\" class=\"form-control\" name=\"" . $non_pk["column_name"] . "\" id=\"" . $non_pk["column_name"] . "\" placeholder=\"" . label($non_pk["column_name"]) . "\" value=\"<?php echo $" . $non_pk["column_name"] . "; ?>\" /></td></tr>";
    }
}
